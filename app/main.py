...
from routes.freelancer_auth_router import router as freelancer_auth_router
from routes.freelancer_profile_router import router as freelancer_profile_router
    ...
    openapi_tags=[
        {
            ...
            "description": "Freelancer registration, login, logout and token refresh"
        },
        {
            "name": "Freelancer Profile",
            "description": "Logged-in freelancer profile and profile updates"
        }
    ]
)
...
app.include_router(freelancer_profile_router)
